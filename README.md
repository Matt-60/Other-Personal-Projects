...
3. **World Layoffs – Silver Layer (SQL)** 
...
4. **Dino Polska S.A. – Financial Analysis (Power BI)**  
...
5. **E‑Bike Sales Analysis & Recommendations (SQL)**  
...
6. **Poznań Half Marathon Dashboard (Power BI)**  
...
7. **Hearing Wellness Report & Recommendations (Power BI)**  
...
8. **Survey Data Cleaning & Visualization (Python)**  
...
9. **Weather Data Exploratory Analysis (Python)**  
